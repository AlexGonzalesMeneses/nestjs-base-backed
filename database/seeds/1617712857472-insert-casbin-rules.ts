...
export class insertCasbinRules1617712857472 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    const registrarCasbin = async (valoresCasbin: any, stack: string) => {
    ...
    const frontEndRoutes = armarCasbinFrontEnd()
    await registrarCasbin(frontEndRoutes, 'frontend')

    const backEndRoutes = armarCasbinBackEnd()
